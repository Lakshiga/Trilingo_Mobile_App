    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.headerBar}>
          ...
          <Text style={styles.headerTitle}>{tx('myProfile')}</Text>
        ...
        <Animated.View style={[styles.heroCard, { opacity: fadeAnim, transform: [{ translateY: slideAnim }, { scale: scaleAnim }] }]}>
          ...
          <View style={styles.userInfo}>
            ...
            <Text style={styles.userRole}>{currentUser?.email || tx('ready')}</Text>
            
            {/* Gamification Badge */}
            <View style={styles.levelBadge}>
               <Text style={styles.levelText}>{tx('level1Explorer')}</Text>
            </View>
            {!currentUser?.isGuest && (
              <View style={styles.statsRow}>
                <View style={styles.statPill}>
                  <MaterialIcons name="star" size={16} color="#FFD700" />
                  <Text style={styles.statText}>{stars} {tx('stars')}</Text>
                </View>
                <View style={styles.statPill}>
                  <MaterialIcons name="check-circle" size={16} color="#34D399" />
                  <Text style={styles.statText}>{completedCount} {tx('completed')}</Text>
                </View>
              </View>
            )}
          </View>
        ...
        {/* --- SETTINGS BUBBLES --- */}
        <Text style={styles.sectionTitle}>{tx('settings')}</Text>
            ...
            return (
              ...
              >
                ...
                <View style={styles.settingContent}>
                  <Text style={styles.settingLabel}>{titleText}</Text>
        ...
        <Text style={styles.versionText}>{tx('version')}</Text>
        ...
        <View style={styles.modalOverlay}>
           <View style={styles.stickerSheet}>
              <View style={styles.modalHeader}>
                 <Text style={styles.modalTitle}>{tx('pickSticker')}</Text>
