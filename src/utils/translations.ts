...
const translations: Record<Language, Translations> = {
  English: {
    ...
    startLearningAdventure: '🌟 Start your learning adventure today! 🌟',
    settings: 'Settings',
  ...
  Tamil: {
    ...
    startLearningAdventure: '🌟 இன்றே உங்கள் கற்றல் சாகசத்தைத் தொடங்குங்கள்! 🌟',
    settings: 'அமைப்புகள்',
  ...
  Sinhala: {
    ...
    startLearningAdventure: '🌟 අදම ඔබේ ඉගෙනීමේ වික්‍රමය ආරම්භ කරන්න! 🌟',
    settings: 'සැකසීම්',
